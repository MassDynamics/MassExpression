...
# param$X2[param$X1 %in% "Species"] <- "Other"
# param$X2[param$X1 %in% "UseNormalisationMethod"] <- "None"
# write_delim(param, "~/Projects/MD/user-data/thermo-diann/new-test/parameters.tsv", delim="\t", col_names = FALSE)
