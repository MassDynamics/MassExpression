...
<details>
  ...
  <span>
    ...
    <ul>
      ...
      <li>Experiment Health. This includes dimensionality reduction plots using all and differentially expressed (DE) proteins; distribution of the coeffiecient of variations by conditions and smaple correlations using all and DE proteins.  </li>
      <li>Feature Completedness. This includes the number of missing values by samples and by protein. </li>
      <li>Normalisation and Imputation. This includes intensity distribution of raw, normalised (when requested) and imputed intensities. </li>
    </ul>
  </span>
</details> 
...
if (params$format == "pdf"){
  ...
  ggplotly(p) %>% plotly::config(displayModeBar = T, 
