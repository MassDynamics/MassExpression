...
if(is.null(p[[1]])) cat("#### Not enough differentially expressed proteins to produce a PCA plot.")
```
...
if(is.null(p)) cat("#### Not enough differentially expressed proteins to produce a correlation plot.")
```
