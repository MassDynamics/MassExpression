...
p_raw <- p_raw + ggtitle("RLE of log2 Raw Intensities") 
...
<details>
  <summary>Density distribution of the imputed and not imputed intensity values used for the differential expression analysis. The distributions are shown by condition of interest</summary>
</details> 
